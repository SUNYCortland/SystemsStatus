...
namespace SystemsStatus.Web.Exceptions
{
    /// <summary>
    ...
    public class ModelStateException : Exception
    {
        ...
        /// </summary>
        public List<AjaxError> Errors { get; private set; }
        ...
        public override string Message
        {
            get
            {
                return string.Join(" ", this.Errors.Select(e => e.Error).ToArray());
            }
        }
        ...
        public ModelStateException()
            : base()
        {
            this.Errors = new List<AjaxError>();
        }
            ...
            : base(info, context)
        {
            ...
            // deserialize
            this.Errors = info.GetValue("ModelStateException.Errors", typeof(List<AjaxError>)) as List<AjaxError>;
        }
        ...
        public override void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            // serialize errors
            info.AddValue("ModelStateException.Errors", this.Errors, typeof(List<AjaxError>));
